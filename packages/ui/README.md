...
[kccinc/kcclab-design-system](https://github.com/kccinc/kcclab-design-system) 저장소에
최소 **Read** 권한이 있어야 설치가 됩니다. 접근이 안 되면 조직 관리자에게 초대를
요청하세요.
...
컴포넌트 목록, 디자인 토큰, 사용 예시는 저장소의
[Storybook](https://github.com/kccinc/kcclab-design-system)과 `CHANGELOG.md`를
참고하세요.
